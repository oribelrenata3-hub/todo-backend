import pool from '../config/db'; // Sesuaikan path ini dengan lokasi file koneksi database kamu

export const TodoModel = {
  // Method dari praktikum sebelumnya (getById, create, update, delete)
  ...
  // Perbarui getByUserId dan tambahkan countByUserId sesuai Langkah 4 di Modul
